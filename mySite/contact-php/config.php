...
define('CONTACTFORM_FROM_ADDRESS', 'mrjafarzadeh.ml');
define('CONTACTFORM_FROM_NAME', 'Mysite');
...
define('CONTACTFORM_TO_ADDRESS', 'togrul.cafarli99@gmail.com');
define('CONTACTFORM_TO_NAME', 'Togrul Jafar');
